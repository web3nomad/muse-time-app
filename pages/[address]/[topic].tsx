  ...
  const Avatar = ({ profile }: { profile: ProfileData }) => {
    return (
      <div className={clsx(
        ...
        ></div>
        <div className="w-32 ml-6 lg:ml-0 flex flex-col justify-start items-start lg:items-center">
          ...
          {walletAddress ? (
            <button
              className="my-2 p-2 text-sm w-full rounded text-white bg-orange-tangelo hover:bg-orange-tangelo/90 flex items-center justify-center"
